...
def com_fabrik():
    os.system("clear")
    os.system("toilet -f standard -F gay DFA Fabrik | lolcat ")
    print (55*"\033[36m_")
...
def list_webdav():
    os.system("clear && toilet -f standard -F metal DFA  Webdav")
    print (55*"\033[36m_")
    while True:
...
def webdav():
    ...
    if plih ==1:
        ...
        list_webdav()
def selgit():
    os.system("clear && toilet -f mono12 -F gay Github")
...
def awal():
    ...
    os.system("sl | lolcat")
    os.system("clear")
    os.system("toilet -f standard -F metal DFA Deface | lolcat ")
    print (55*"\033[33m_")
